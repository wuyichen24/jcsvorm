...
public class UserError8 {
	...
	@CsvColumn(name = "perf_balance", pos = 6)   // not sequential pos value
	private double performance;
	
	@CsvColumn(name = "health", pos = 7)
	private boolean isHealth;

	public UserError8(String name, int salary, Date dob, double performance, boolean health) {
		this.name = name;
		this.salary = salary;
		this.dob = dob;

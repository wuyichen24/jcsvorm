...
@CsvEntity
public class UserError6 {
	@CsvColumn(name = "name", pos = 0)
	private String name;
	
	@CsvColumn(name = "int_amount", pos = -9)   // negative pos value
	private int    salary;
	...
	public UserError6(String name, int salary, Date dob, double performance, boolean health) {
		this.name = name;
		this.salary = salary;
		this.dob = dob;
